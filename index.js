...
app.post("/auth/login", (req, res) => {
    ...
    signInWithEmailAndPassword(firebaseAuth, loginUser.email, loginUser.password)
        .then(async (response) => {
            ...
            if(code != undefined) {
                //call mysql query to update table and set CODE to null
                console.log("TRYING TO REMOVE FOLLOWING CODE: "+code);
                await updateRemovesCode(code);
            }
            res.status(200).json({
                status: "Success",
...
//EXAMPLE OF A URL GENERATED BY THE EMAIL-SERVICE: 
// -- REGISTERED USER --> "https://authentication-service-si.azurewebsites.net/auth/acceptInvite?code=f38e5406-25d8-4996-a69a-11617ba99e97&email=dimi@gmail.com"
// -- UNREGISTERED USER --> "https://authentication-service-si.azurewebsites.net/auth/acceptInvite?code=1794e14a-f4c0-4942-b2ca-9566f5efc85d&email=dimi44@gmail.com"
