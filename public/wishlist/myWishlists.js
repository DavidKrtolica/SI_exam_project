...
const getWishlists = async () => {
    ...
    socket.emit('getWishlists');

    socket.on('getWishlistsSucceeded', ({ result }) => {
        console.log('getWishlistsSucceeded', result);
    ...
    socket.on('getWishlistsFailed', () => {
        console.log('getWishlistsFailed');
    })
}
